    ...
    <section class="work_details">
        ...
        <div class="text">
            ...
            <div class="desc">
                <h2>デザインについて</h2>
                <p>
                    ハンバーガーのWEB広告用バナーをデザインし制作しました。20代の男性をターゲットに、休日のランチや夕食にハンバーガーを食べることを想定しました。高級感を第一に、シンプルなデザインを目指しました。そのために、背景に黒い光沢のあるグラデーションを適用し、ハンバーガーにスポットライトが当たっているような加工をしました。文字は、明朝体にし、文字間隔や各要素の余白を大きくとりました。
                </p>
            </div>
        </div>
        <!-- <div class="whole_pic">
